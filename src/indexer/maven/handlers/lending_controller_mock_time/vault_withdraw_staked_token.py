...
async def vault_withdraw_staked_token(
    ctx: HandlerContext,
    vault_withdraw_staked_token: TezosTransaction[VaultWithdrawStakedTokenParameter, LendingControllerMockTimeStorage],
) -> None:
    ...
    try:
        ...
        collateral_token_name       = vault_withdraw_staked_token.parameter.tokenName
