...
from maven.types.lending_controller_mock_time.tezos_parameters.vault_deposit_staked_token import VaultDepositStakedTokenParameter
...
async def vault_deposit_staked_token(
    ctx: HandlerContext,
    vault_deposit_staked_token: TezosTransaction[VaultDepositStakedTokenParameter, LendingControllerMockTimeStorage],
) -> None:
