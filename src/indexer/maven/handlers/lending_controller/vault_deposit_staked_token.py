...
from maven.types.lending_controller.tezos_parameters.vault_deposit_staked_token import VaultDepositStakedTokenParameter
...
async def vault_deposit_staked_token(
    ctx: HandlerContext,
    vault_deposit_staked_token: TezosTransaction[VaultDepositStakedTokenParameter, LendingControllerStorage],
) -> None:
